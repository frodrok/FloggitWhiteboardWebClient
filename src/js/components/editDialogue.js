        ...
        <fieldset>
          ...
          <div className="form-group">
            ...
            <div className="col-lg-10">
              <input type="text" className="form-control" id="inputTitle" defaultValue={props.data.postIt.title} ref={(c) => { title = c; }} />
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-lg-10">
              <textarea className="form-control" id="description" defaultValue={props.data.postIt.text} ref={(c) => { text = c; }} />
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-lg-10">
              <select className="form-control" id="color">
                {
                ['blue', 'green', 'pink', 'orange', 'red'].map(val => <option selected={val === props.data.postIt.color}>{val}</option>)
                }
              </select>
            </div>
          </div>
